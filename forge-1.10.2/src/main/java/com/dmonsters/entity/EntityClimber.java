...
public class EntityClimber extends EntityMob
{
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(4, new DeadlyMonsterAIMeelee(this, 1.0D, true));
        this.tasks.addTask(5, new EntityAIWander(this, 0.8D));
        this.tasks.addTask(6, new EntityAIWatchClosest(this, EntityPlayer.class, 8.0F));
        this.tasks.addTask(6, new EntityAILookIdle(this));
        this.targetTasks.addTask(1, new EntityAIHurtByTarget(this, false, new Class[0]));
        this.targetTasks.addTask(2, new EntityClimber.AISpiderTarget<EntityPlayer>(this, EntityPlayer.class));
        this.targetTasks.addTask(3, new EntityClimber.AISpiderTarget<EntityIronGolem>(this, EntityIronGolem.class));
    }
